...
class SephpaTest extends PHPUnit_Framework_TestCase
{
    public function testCreditTransfer00100203()
    {
        ...
        $this->assertXmlStringEqualsXmlFile(__DIR__ . '/creditTransferValid00100203.xsd',
                                            $creditTransferFile->generateXml('2014-10-19T00:36:11'));
    }
    ...
    public function testCreditTransfer00100303()
    {
        ...
        $this->assertXmlStringEqualsXmlFile(__DIR__ . '/creditTransferValid00100303.xsd',
                                            $creditTransferFile->generateXml('2014-10-19T00:38:44'));
    }
    ...
    public function testDirectDebit00800202()
    {
       ...
       // needed information about the
        ...
        $this->assertXmlStringEqualsXmlFile(__DIR__ . '/directDebitValid00800202.xsd',
                                            $directDebitFile->generateXml('2014-10-19T00:36:11'));
    }
    ...
    public function testDirectDebit00800302()
    {
       ...
       // needed information about the
        ...
        $this->assertXmlStringEqualsXmlFile(__DIR__ . '/directDebitValid00800302.xsd',
                                            $directDebitFile->generateXml('2014-10-19T00:38:44'));
    }
